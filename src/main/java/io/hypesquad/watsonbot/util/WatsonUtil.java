...
/**
 * Represents an Utility class for different useages
 *
 * @author Kevin
 */
public class WatsonUtil {
    ...
    public static String getProperty(String key) {
        ResourceBundle resourceBundle = ResourceBundle.getBundle("watson"); //change to constant if used multiple times
